// owner.js - FIXED VERSION WITH PROPER FUNCTION ORDERING
...
async function editCustomer(customerId) {
  // ... [your existing editCustomer implementation]
  // This function should be properly defined here
  console.log("Edit customer:", customerId);
  // Add your edit customer implementation
}

async function updateCustomer(customerId) {
  // ... [your existing updateCustomer implementation]
  console.log("Update customer:", customerId);
  // Add your update customer implementation
}
...
async function addPayment() {
  // ... [your existing addPayment implementation]
  console.log("Add payment for:", currentCustomerId);
  // Add your add payment implementation
}

async function deletePayment(customerId, paymentDate) {
  // ... [your existing deletePayment implementation]
  console.log("Delete payment:", customerId, paymentDate);
  // Add your delete payment implementation
}

async function deleteCustomer(customerId, customerName) {
  // ... [your existing deleteCustomer implementation]
  console.log("Delete customer:", customerId, customerName);
  // Add your delete customer implementation
}
